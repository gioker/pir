...
bool Database::search(QString fileName, bool bitCode[2048], bool bitCodeMask[2048], double& hamDist, QString& foundIris) {
	double threshold = 0.1;//0.3; // Our Hamming distance threshold -- what we consider a "match"
